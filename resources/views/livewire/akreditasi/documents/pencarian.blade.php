<div class="flex flex-col gap-4">
    ...
    <div class="flex w-full flex-col gap-2 lg:grid lg:w-1/2 lg:grid-cols-3">
        ...
        <div wire:key="element-select-{{ $sub_id }}">
            <x-ts:select.styled wire:model.blur="element_id" searchable :request="route('api.akreditasi.elements', ['sub' => $sub_id])" select="label:label|value:id" :disabled="!$sub_id" placeholder="Element" />
        </div>
    </div>
